...
class ModernIDManager:
    def __init__(self):
        ...
        self.windsurf_icon = ImageTk.PhotoImage(
            Image.open("public/image/windsurf-icon.png").resize(icon_size, Image.Resampling.LANCZOS)
        )
    ...
    def setup_ui(self):
        ...
        system_info = f"System: Windows 10"
        version_info = "Version 1.0 (Released: Dec 24, 2024)"
